...
{
    public partial class ControlSalesOrderBOQSummary : UserControl
    {
        ...
        public ControlSalesOrderBOQSummary()
        {
            InitializeComponent();
        }
        public ControlSalesOrderBOQSummary(SalesOrderBOQViewModel model)
        {
            InitializeComponent();
            BOQ_MODEL = model;
        }
        public void PopulateBOQSummaryControl()
        {
            ...
            try
            {
                ...
                _service.UpdateSalesOrderBOQSummary(this.BOQ_MODEL);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(errMessage, "ControlSalesOrderBOQSummary::PopulateBOQSummaryControl", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                string errMessage = ex.Message;
                if (ex.InnerException != null) errMessage += string.Format("\n{0}", ex.InnerException.Message);
                MessageBox.Show(errMessage, "ControlSalesOrderBOQSummary::btnUpdate_Click", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            this.Cursor = Cursors.Default;
        }
    }
