...
{
    public partial class ControlSalesOrderBOQSheetSummary : UserControl
    {
        public SalesOrderBOQSheetSummary MODEL { get; set; }
        public ControlSalesOrderBOQSheetSummary()
        {
            InitializeComponent();
        }
        public void PopulateSummaryInfoControl()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(errMessage, "ControlSalesOrderBOQSheetSummary::PopulateSummaryInfoControl", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
