...
{
    public partial class ControlSalesOrderBOQSheet : UserControl
    {
        // Declare an event 
        ...
        private ServiceSalesOrderBOQ _BOQ_SERVICE = null;
        public SalesOrderBOQSheet BOQ_SHEET_MODEL { get; set; }
        public SalesOrderBOQViewModel BOQ_MODEL { get; set; }
        ...
        private ControlSalesOrderBOQItemCharges _ctrlChargesInfo = null;
        private void InitializeBOQItemChargesInfoControl()
        {
            _ctrlChargesInfo = new ControlSalesOrderBOQItemCharges();
        ...
        private ControlSalesOrderBOQSheetSummary _ctrlSheetSummaryInfo = null;
        private void InitializeBOQSheetSummaryInfoControl()
        {
            _ctrlSheetSummaryInfo = new ControlSalesOrderBOQSheetSummary();
            splitContainerMain.Panel2.Controls.Add(_ctrlSheetSummaryInfo);
            _ctrlSheetSummaryInfo.Dock = DockStyle.Fill;
        }


        public ControlSalesOrderBOQSheet()
        {
            InitializeComponent();
        ...
        public ControlSalesOrderBOQSheet(SalesOrderBOQSheet Sheet)
        {
            InitializeComponent();
        ...
        {
            _BOQ_SERVICE = new ServiceSalesOrderBOQ();
