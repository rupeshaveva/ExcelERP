...
{
    public partial class ControlSalesOrderBOQItemCharges : UserControl
    {
        // Declare an event 
        ...
        public ControlSalesOrderBOQItemCharges()
        {
            InitializeComponent();
        ...
        private void GatherDataIntoModelAndPerformCalculations()
        {
            try
            {
                ...
                (new ServiceSalesOrderBOQ()).CalculateChargesOnBOQItem(ITEM_CHARGES_INFO);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(errMessage, "ControlSalesOrderBOQItemCharges::GatherDataIntoModelAndPerformCalculations", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void ScatterDataIntoControls()
        {
            ...
            catch (Exception ex)
            {
                string errMessage = ex.Message;
                if (ex.InnerException != null) errMessage += string.Format("\n{0}", ex.InnerException.Message);
                MessageBox.Show(errMessage, "ControlSalesOrderBOQItemCharges::ScatterDataIntoControls", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        private void ItemChargeValue_Changed(object sender, EventArgs e)
        {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                string errMessage = ex.Message;
                if (ex.InnerException != null) errMessage += string.Format("\n{0}", ex.InnerException.Message);
                MessageBox.Show(errMessage, "ControlSalesOrderBOQItemCharges::btnUpdate_Click", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
