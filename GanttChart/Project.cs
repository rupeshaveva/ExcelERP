...
namespace Braincase.GanttChart
{
        ...
        where R : class
    {
        ...
        List<R> _mAllResources = new List<R>();
        ...
        {
            if (!this._mAllResources.Contains(resource))
                _mAllResources.Add(resource);
        }
        ...
        public IEnumerable<R> GetAllResources()
        {

            return _mAllResources;
        }
